...
const handleSubmit = (e) => {
    ...
    const valorHora = (valorProjeto / (diasEfetivos * 4 * horasDiarias)) + ((diasFerias * diasEfetivos * horasDiarias));
...
document.querySelector("input[name='valorProjeto']").addEventListener("change", formatCurrency);
